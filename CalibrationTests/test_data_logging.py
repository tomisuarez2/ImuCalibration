...
#file_name = log_data_from_imu('COM3', 38400, 1, t_avar=100) # t init calculation data log
file_name = log_data_from_imu('COM3', 38400, 0, t_init=36.5, t_wait=3, t_move=4, n_moves=9) # calibration data log
